...
@app.route('/yake/extract_keywords_url',methods=['POST'])
def handle_url():
    """Example endpoint return a list of keywords using YAKE by URL
    ---
    consumes:
      - application/json
    produces:
    ...
    try:
        assert request.json["url"] , "Invalid URL"
        ...
        keywords = my_yake.extract_keywords(extracted_text)
...
@swagger.validate('content')
@app.route('/yake/extract_keywords_text',methods=['POST'])
def handle_text():
